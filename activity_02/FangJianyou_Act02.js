...
function main() {
    ...
    vbo1 = new VBOBox(g_gl, vShaderGauroud, fShaderGauroud);
...
function keyDownHandler(e) {
    switch (e.keyCode) {
        ...
        case 73: // i
            ...
            break;
        case 32:
            vbo1.switchWorldLight();
            break;
        case 66:
            vbo1.switchHeadLight();
            break;
        case 49:
        case 50:
        case 51:
        case 52:
            vbo1.switchLightShading(e.keyCode - 49);
            break;
        case 55:
        case 56:
        case 57:
            vbo1.updateAttenuation(e.keyCode - 55);
            break;
        case 53:
            vbo1.switchDistortion();
            break;
        case 37: // ←
    ...
    vbo1.updateKeyEvents(cameraControl, directionControl, lightControl);
}
