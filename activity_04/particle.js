...
class ParticleSystem {
    ...
    init(partCount) {
        ...
        for (let i = 0; i < partCount; i++) {
            ...
            particle.pos = [Math.random() * 8.0 - 4.0, Math.random() * 8.0 - 4.0, 0];
            ...
            particleNext.pos = [Math.random() * 8.0 - 4.0, Math.random() * 8.0 - 4.0, 0];
        ...
        for (let i = 1; i < this.particleCount; i++) {
            ...
            for (let j = i + 1; j < this.particleCount; j++) {
                let repulse = new Force();
                repulse.type = Force.REPULSIVE;
                repulse.k_spring = 2.0;
                repulse.length_spring = 0.4;
                repulse.index_p0 = i;
                repulse.index_p1 = j;
                this.forceSet.push(repulse);
            }
