...
class VBOBox {
    ...
    initVertices() {
        ...
        this.gl.vertexAttribPointer(
            this.glVertexPosition, 3, this.gl.FLOAT, false, this.fSize * this.floatsPerVertex, 0);
        this.gl.vertexAttribPointer(
            this.glVertexColor, 4, this.gl.FLOAT, false, this.fSize * this.floatsPerVertex, this.fSize * 3);
        this.gl.vertexAttribPointer(
            this.glVertexNormal, 3, this.gl.FLOAT, false, this.fSize * this.floatsPerVertex, this.fSize * 7);
        this.gl.vertexAttribPointer(
            this.glVertexSize, 1, this.gl.FLOAT, false, this.fSize * this.floatsPerVertex, this.fSize * 10);
